  ...
  return (
    ...
    <div className=" flex flex-wrap  px-3 gap-3 justify-center items-center mt-3 sm:mt-16 ">
      ...
      { setdata.map((data,index)=>(
          ...
          <img className="rounded-4xl w-[330px] sm:w-[380px] h-[300px] " src={data.images[0] || "https://tse3.mm.bing.net/th?id=OIP.6zphlNCErJX8RdfcceEYBQHaE8&pid=Api&P=0&h=180" } alt="" />
